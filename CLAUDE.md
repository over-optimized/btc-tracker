...
# End-to-End Testing (run locally after feature completion)
...
pnpm lint      # ESLint checking (must pass - 0 critical errors)
pnpm format    # Prettier formatting
pnpm dev       # Development server
pnpm build     # Production build
pnpm typecheck # TypeScript type checking (if available)

# Pre-Push Quality Gates (enforced by Husky hooks)
pnpm quality   # Must pass before any git push
pnpm ci        # Full CI pipeline validation
```
