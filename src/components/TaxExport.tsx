    ...
    return (
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="text-center text-gray-600">
          ...
          <h3 className="text-lg font-semibold mb-2">Export Tax Report</h3>
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-bold text-gray-800">Export Tax Report</h2>
      </div>
              ...
              {!exportOptions.includeSummaryOnly && (
                <label className="flex items-center gap-2 ml-6">
                  <input
                    ...
                    className="text-indigo-600 focus:ring-indigo-500 rounded"
                  />
                  <span className="text-sm text-gray-700">Include remaining tax lot details</span>
                </label>
              )}
            </div>
